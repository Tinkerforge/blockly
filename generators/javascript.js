...
'         if (\'codeButtonEnable\' in message.data) {\n'+
'           _code_button_enable = message.data.codeButtonEnable;\n'+
'         }\n'+
'        _worker_id = message.data.wid;\n'+
'        _dict_variables = message.data.dictv;\n'+
'        _iterator_main.next();\n'+
